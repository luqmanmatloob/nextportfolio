  ...
  return (
    <div className='mt-10 mb-10 container flex flex-col items-center mx-auto '>
      ...
      <div className=' mb-16'>
        <div className='md:flex max-w-[80%] mx-auto text-center  '>
          <div className='flex flex-col items-center '>
            ...
            <p className='text-[#6854FC] font-semibold my-5'>
      ...
      <p className='max-w-[80%] text-center mx-auto mt-3 my-5'>
        Dictum tortor, sed scelerisque mattis malesuada. Urna sed magna a sed
        nulla egestas bibendum eget. Consectetur urna varius dolor, fermentum
        turpis. Sit malesuada id tortor viverra gravida cras. In quis.
      </p>

      <div className='flex flex-wrap gap-8 my-5 justify-center '>
        <Image src='/img/html.png' alt='' width='70' height='70' className='' />
        <Image src='/img/css.png' alt='' width='70' height='70' className='' />
        <Image
        ...
        <Image
          ...
          className=''
        />
        <Image src='/img/git.png' alt='' width='70' height='70' className='' />
      </div>
